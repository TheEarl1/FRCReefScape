...
public class Drive extends SubsystemBase {
  ...
  private Drive() {
    ...
    ModuleConfig kSwerveModuleConfig = new ModuleConfig(Constants.kWheelDiameterMeters/2, Constants.kMaxSpeedMetersPerSecond, 
            Constants.kPathFollowerWheelCoeficientFriction, neovortex, Constants.kDrivingMotorCurrentLimit, 4);
    AutoBuilder.configure(
        ...
        new PPHolonomicDriveController(Constants.kPathFollowerTranslationPID, Constants.kPathFollowerRotationPID),
        new RobotConfig(Constants.kPathFollowerMass, Constants.kPathFollowerMomentOfInertia, kSwerveModuleConfig, Constants.kModulePositions),
        () -> {
