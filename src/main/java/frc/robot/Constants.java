...
public final class Constants {
    ...
    public static final SwerveDriveKinematics kDriveKinematics = new SwerveDriveKinematics(
        kRightFrontModulePosition, kLeftFrontModulePosition, kRightRearModulePosition, kLeftRearModulePosition);
    ...
    public static final double kPathFollowerBaseRadius = Constants.kBaseRadius; // Drive base radius in meters
